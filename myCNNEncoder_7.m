% this script encodes the input image. Similar to the vl_simplenn, but not
% that much layers. I think right after
function res = myCNNEncoder_7(net, x, dzdy, res, varargin)
...
%n = numel(net.layers) ;
% ********* define n to be n-7 excluding the last layers here,excluding the last max-pooling layer
n= numel(net.layers)-7; 
%**********************************
